...
| Session-end actionable optimization (non-blocking) | Numbered todo in `.learnings/OPTIMIZATION_TODOS.md` (`OPT-YYYYMMDD-NNN`); see `.ai/01_project_constraints/25_session_end_optimization_todo.md` — distinct from LEARNINGS (experience vs executable todo) |
