...
api_version: "apiv3"
product: "H5支付"
url_display: "https://pay.weixin.qq.com/doc/v3/merchant/4012791831"
title_display: "APIv3/普通商户/支付产品/H5支付/开发指引"
---
...
```mermaid
%%{init: { "sequence": { "wrap": false, "wrapPadding": 10, "noteAlign": "left", "height":110,
    "messageMargin":45 } } }%%
sequenceDiagram
        actor User as 用户
        participant Mch@{ type: boundary }  as 商户H5前端
...
```mermaid
%%{init: { "sequence": { "wrap": true, "wrapPadding": 10, "noteAlign": "left",    "height":100,
    "messageMargin":45 } } }%%
sequenceDiagram
        autonumber ea
        actor User as 用户
