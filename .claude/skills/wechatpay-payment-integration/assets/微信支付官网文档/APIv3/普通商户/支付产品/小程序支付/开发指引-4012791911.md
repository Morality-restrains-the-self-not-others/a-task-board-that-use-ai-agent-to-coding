...
api_version: "apiv3"
product: "小程序支付"
url_display: "https://pay.weixin.qq.com/doc/v3/merchant/4012791911"
title_display: "APIv3/普通商户/支付产品/小程序支付/开发指引"
---
...
sequenceDiagram
        autonumber ea
        actor User as 用户
        participant Mch@{ type: boundary } as 商户小程序
...
```mermaid
%%{init: { "sequence": { "wrap": true, "wrapPadding": 10, "noteAlign": "left",  "height":110,
    "messageMargin":45
 } } }%%
sequenceDiagram
