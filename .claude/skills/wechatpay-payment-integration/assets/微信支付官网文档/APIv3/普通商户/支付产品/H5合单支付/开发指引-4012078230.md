...
api_version: "apiv3"
product: "H5合单支付"
url_display: "https://pay.weixin.qq.com/doc/v3/merchant/4012078230"
title_display: "APIv3/普通商户/支付产品/H5合单支付/开发指引"
---
...
```mermaid
%%{init: { "sequence": { "wrap": false, "wrapPadding": 10, "noteAlign": "left", "height":110, "messageMargin":45 } } }%%
sequenceDiagram
        actor User as 用户
        participant Mch@{ type: boundary } as 商户H5前端
        participant Mch2@{ type: control } as 商户后端
...
```mermaid
%%{init: { "sequence": { "wrap": true, "wrapPadding": 10, "noteAlign": "left", "height":110, "messageMargin":45 } } }%%
sequenceDiagram
        autonumber ea
        actor User as 用户
        participant Mch@{ type: boundary } as 商户H5前端
