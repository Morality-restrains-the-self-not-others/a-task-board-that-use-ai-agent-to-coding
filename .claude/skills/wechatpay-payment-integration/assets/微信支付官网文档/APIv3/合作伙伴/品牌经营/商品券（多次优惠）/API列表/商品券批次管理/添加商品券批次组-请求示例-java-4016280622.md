...
title_display: "APIv3/合作伙伴/品牌经营/商品券（多次优惠）/API列表/商品券批次管理/添加商品券批次组-请求示例-java"
---
...
public class CreateStockBundle {
  ...
  public static void main(String[] args) {
    ...
    request.stockBundle.usageRuleDisplayInfo.appPath = "https://www.daydaymoney.com/jump-to-app";
