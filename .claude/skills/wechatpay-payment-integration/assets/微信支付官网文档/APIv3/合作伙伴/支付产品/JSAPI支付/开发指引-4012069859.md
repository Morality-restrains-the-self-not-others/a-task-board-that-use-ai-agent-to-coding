...
api_version: "apiv3"
product: "JSAPI支付"
url_display: "https://pay.weixin.qq.com/doc/v3/partner/4012069859"
title_display: "APIv3/合作伙伴/支付产品/JSAPI支付/开发指引"
---
...
sequenceDiagram
  autonumber
  actor p0 as 用户
  participant p1 as 服务商/子商户前端页面(微信浏览器打开)
  participant p2 as 服务商后端
  participant p3 as 微信支付系统
  p0->>p1: 用户下单
  p1->>p2: 发送下单请求
  p2->>p3: 调用JSAPI/小程序下单接口
  p3-->>p2: 下单成功返回prepay_id
  p2-->>p1: 返回JSAPI拉起支付所需参数
```
