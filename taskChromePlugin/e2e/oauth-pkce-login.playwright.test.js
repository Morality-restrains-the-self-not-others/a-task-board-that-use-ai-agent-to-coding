 ...
 *
 * 覆盖：真实扩展加载 → popup 发起 oauthStart → taskAuth 授权页（生产 www.daydaymoney.com）
...
const BASE_URL = process.env.OAUTH_E2E_BASE_URL || 'https://www.daydaymoney.com';
const EMAIL = process.env.OAUTH_E2E_EMAIL || 'contact@daydaymoney.com';
