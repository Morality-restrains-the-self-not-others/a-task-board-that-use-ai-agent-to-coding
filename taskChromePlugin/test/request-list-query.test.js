...
describe('filterRequests', () => {
  const list = [
    req({ id: '1', url: 'https://api.daydaymoney.com/users', method: 'GET', statusCode: 200, type: 'xhr' }),
    req({ id: '2', url: 'https://api.daydaymoney.com/users', method: 'POST', statusCode: 201, type: 'fetch' }),
    req({ id: '3', url: 'https://cdn.example.com/app.js', method: 'GET', statusCode: 200, type: 'script' }),
    req({ id: '4', url: 'https://api.daydaymoney.com/fail', method: 'GET', statusCode: 404, type: 'xhr' }),
    req({ id: '5', url: 'https://api.daydaymoney.com/abort', method: 'GET', statusCode: 0, canceled: true, type: 'xhr' }),
...
describe('panel applyRequestFilters wiring', () => {
  ...
  it('uses RequestListQuery and keeps type/sort state', () => {
    ...
    const P = {
      state: {
        recentRequests: [
          req({ id: 'keep', method: 'GET', url: 'https://api.daydaymoney.com/users', statusCode: 200, type: 'xhr', timestamp: 1 }),
          req({ id: 'drop-method', method: 'POST', url: 'https://api.daydaymoney.com/users', statusCode: 201, type: 'xhr', timestamp: 2 }),
          req({ id: 'newer', method: 'GET', url: 'https://api.daydaymoney.com/users', statusCode: 200, type: 'xhr', timestamp: 9 }),
        ],
