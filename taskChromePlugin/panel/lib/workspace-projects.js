...
(function () {
  ...
  P.checkPanelAidevMatchingProjects = function (containerId, wsId) {
    if (!state.pendingAidevMatches?.length || typeof DaydaymoneyMeta === 'undefined') return;
    const pids = DaydaymoneyMeta.projectIdsForWorkspace(state.pendingAidevMatches, wsId);
