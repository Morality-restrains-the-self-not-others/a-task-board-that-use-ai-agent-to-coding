...
(function () {
  ...
  const WORK_BRANCH_PRESET_OPTIONS = [
    { value: 'feature', label: 'feature/${日期}_daydaymoney${taskId}_${标题}' },
    { value: 'bugfix', label: 'bugfix/${日期}_daydaymoney${taskId}_${标题}' },
    { value: 'hotfix', label: 'hotfix/${日期}_daydaymoney${taskId}_${标题}' },
