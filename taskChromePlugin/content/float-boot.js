...
var isOpen = false;
/** 本次打开浮窗（鉴权/daydaymoney 完成后）的表单快照；创建成功后还原 */
...
var apiCfg = { baseUrl: 'https://daydaymoney.com', token: '' };
var workspacesData = [];
var projectsData = [];
var pendingAidevMatches = null;
var aidevStatusEl = document.getElementById('taskplugin-daydaymoney-status');
