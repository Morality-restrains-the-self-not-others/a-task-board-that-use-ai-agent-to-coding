...
if (!process.env.VITEST) {
  console.log('[skip] SystemAdminUsers.edit-user-id.test.js requires vitest runtime')
} else {
  ...
  describe('SystemAdminUsers edit form user id', () => {
    beforeEach(() => {
    ...
    it('shows the user id as a readonly string in the edit form', async () => {
      ...
      const field = wrapper.get('#edit-user-id')
      expect(field.element.value).toBe('871586263134662656')
      expect(field.element.readOnly).toBe(true)
    })
  })
}
