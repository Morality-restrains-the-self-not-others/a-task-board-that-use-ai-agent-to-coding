// @ts-check
/**
 * Playwright config for TaskDetail comment-execution-git-oauth-summary E2E test.
...
export default defineConfig({
  testDir: '.',
  testMatch: '**/TaskDetail.comment-execution-git-oauth-summary.playwright.test.js',
  fullyParallel: false,
